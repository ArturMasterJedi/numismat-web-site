<?php
/* Smarty version 3.1.39, created on 2021-11-29 20:22:17
  from 'C:\OpenServer\domains\numismat\templates\main.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_61a50c49df6966_08852739',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'ab01506349581d30ce2519448ccfab57c6e61d72' => 
    array (
...
function content_61a50c49df6966_08852739 (Smarty_Internal_Template $_smarty_tpl) {
?><!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<?php echo '<script'; ?>
 src="https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.2.1/owl.carousel.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="/assets/scripts/modernizr.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="/assets/scripts/"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="/assets/scripts/main.js" defer><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="/assets/scripts/jquery.sticky.js" defer><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="/assets/scripts/popper.min.js" defer><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="/assets/scripts/jquery.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="/assets/scripts/bootstrap.bundle.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="/assets/scripts/lightslider.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
...
>
<?php echo '<script'; ?>
 src="/assets/scripts/slick.min.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="/assets/scripts/nouislider.min.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="/assets/scripts/jquery.zoom.min.js"><?php echo '</script'; ?>
>
</body>
</html><?php }
}
